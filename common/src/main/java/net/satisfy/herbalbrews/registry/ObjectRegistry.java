...
import net.satisfy.herbalbrews.blocks.CauldronBlock;
import net.satisfy.herbalbrews.blocks.*;
import net.satisfy.herbalbrews.items.*;
import net.satisfy.herbalbrews.util.FoodComponent;
...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Item> BLACK_TEA = registerItem("black_tea", () -> new DrinkItem(getFoodItemSettings(0.7f, EffectRegistry.REVITALIZING.get(), 900)));
    ...
    public static final RegistrySupplier<Item> MILK_COFFEE = registerItem("milk_coffee", () -> new DrinkBlockItem(MILK_COFFEE_BLOCK.get(), getSettings().food(new FoodProperties.Builder().nutrition(Foods.SWEET_BERRIES.getNutrition()).saturationMod(Foods.SWEET_BERRIES.getSaturationModifier()).alwaysEat().build()), new MobEffectInstance(EffectRegistry.TOUGH.get(), 1100, 0)));
    public static final RegistrySupplier<Item> COFFEE = registerItem("coffee", () -> new DrinkItem(getFoodItemSettings(0.7f, EffectRegistry.TOUGH.get(), 900)));
    ...
    public static final RegistrySupplier<Item> HERBALBREWS_STANDARD = registerItem("herbalbrews_standard", () -> new HerbalbrewsStandardItem(new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));    public static final RegistrySupplier<Block> POTTED_LAVENDER = registerWithoutItem("potted_lavender", () -> new FlowerPotBlock(LAVENDER.get(), BlockBehaviour.Properties.copy(Blocks.FLOWER_POT)));
