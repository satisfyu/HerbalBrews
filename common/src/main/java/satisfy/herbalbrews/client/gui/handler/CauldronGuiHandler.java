package satisfy.herbalbrews.client.gui.handler;
...
import satisfy.herbalbrews.client.gui.handler.slot.OutputSlot;
import satisfy.herbalbrews.client.recipebook.group.CauldronRecipeBookGroup;
