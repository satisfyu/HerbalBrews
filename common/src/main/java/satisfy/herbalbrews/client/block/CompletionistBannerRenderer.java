package satisfy.herbalbrews.client.block;
...
import satisfy.herbalbrews.blocks.CompletionistBannerBlock;
import satisfy.herbalbrews.blocks.CompletionistWallBannerBlock;
...
public class CompletionistBannerRenderer implements BlockEntityRenderer<CompletionistBannerEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(HerbalBrews.MOD_ID, "completionist_banner"), "main");
